<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllAnnouncements.aspx.cs" Inherits="MyHome.WebForms.AllAnnouncements" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="nav">
            ...
            <asp:Button ID="Button6" class="navbtns" runat="server" OnClick="Button6_Click" Text="View Profile" Width="236px" />
        ...
        <div>
            <%if (taskName != null)
                ...
                %>
                <div class="rectangle">
                    <p class="texta"><%: taskBy[i] %></p>                    
                    <p class="textn"><%: taskName[i] %> </p>
                    <p class="texta"><%: taskOn[i] %></p>
                </div>
                <% }  %>
                <%} else { %>
