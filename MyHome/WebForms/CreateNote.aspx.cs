...
{
    public partial class CreateNote : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            obj.MakeNote(Convert.ToInt32(Request.QueryString["ID"]), Convert.ToInt32(Request.QueryString["GID"]), announcetxt.Text);
